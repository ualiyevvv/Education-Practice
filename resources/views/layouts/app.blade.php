        ...
        <header>
            <div class="container">
                <nav class="menu">
                    ...
                    <a class="menu__li <?=$classNews?>" href="{{ route('news.index') }}">News </a>
                    <a class="menu__li <?=$classPrice?>" href="{{ route('price') }}">pricelist</a>
                    <a class="menu__li <?=$classShop?>" href="{{ route('shop.index') }}">shop</a>
                    <a class="menu__li <?=$classContacts?>" href="{{ route('contacts') }}">contacts</a>
                </nav>
